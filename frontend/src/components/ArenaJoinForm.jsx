...
import "../styles/ArenaJoinForm.css"
import closeBtn from '../assets/close.svg'

import toast, { Toaster } from 'react-hot-toast';
import io from 'socket.io-client';

export default function ArenaJoinForm({setShowForm}) {
  ...
  return (
    <div className='arena_form_container'>
      ...
      <input
        ...
        onKeyUp={handleInputEnter}
      />
      <Link to={"/battleArena/" + arenaId + "/" + roomId} className="btn joinBtn" onClick={()=>joinRoom()} state={{roomId: roomId, username: username, authority: 'guest'}} >
        Join
      </Link>
